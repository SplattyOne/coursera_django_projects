...
WSGI_APPLICATION = 'tomattosite.wsgi.application'
...
try:
    ...
    print('When you want to use social login, please see tomattosite/github_settings-dist.py')
